...
export default class extends Component {
    ...
    renderPaddingContent () {
        if (this.totalHeight === -1 || this.childHeight === -1) {
            return (
                <View style = {{height: 500}}></View>
            );
        } else if (this.totalHeight - this.childHeight > 50) {
            return (
                <View style = {{
                    height: this.totalHeight - this.childHeight,
    ...
    render() {
        ...
        return (
            <View onLayout = {e => {
                this.totalHeight = e.nativeEvent.layout;
                this.setState({
                    paddingReady: true
                });
            }}>
            <ScrollView
                ...
                onScroll={(e)=>this.onScroll(e)}>
                    ...
                    <View ref = 'childWrapper' onLayout = {e => {
                        this.childHeight = e.nativeEvent.layout.height;
                        this.setState({
                            paddingReady: true
                        });
                    }}>
